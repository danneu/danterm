...
public enum IpcRequestMethod: String, CaseIterable, Sendable {
    ...
    /// footprint work reads it for. It sits under `debug` because it reports
    /// internal state rather than controlling anything.
    case debugSurfaces = "debug.surfaces"
    ...
    private var traits: IpcRequestMethodTraits {
        ...
        case .doctorAppFacts, .ls, .focusInfo, .debugSurfaces, .roster, .tailnetStatus,
...
public enum IpcRequest: Equatable, Sendable {
    ...
    public var method: IpcRequestMethod {
        ...
        case .debugSurfaces: return .debugSurfaces
    ...
    var projection: IpcRequestProjection {
        switch self {
        case .ping, .doctorAppFacts, .ls, .focusInfo, .debugSurfaces, .roster, .tailnetStatus, .quit:
