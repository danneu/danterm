...
// rather than text, so projecting and normalizing every pane happens wherever the returned
...
/// Work that reads, normalizes, grafts, and encodes -- none of which happens here. This is
