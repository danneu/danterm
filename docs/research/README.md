...
| 41 | [Baseline memory with ten tabs](41-baseline-memory-ten-tabs/README.md) | What the process holds with many idle tabs, by allocation class | Phase 3 banked: 644 MB to 56.5 MB idle (`F10`); remainder is two classes (`F12`); `T11`-`T14` open |
