...
| 28 | [Retained-row optimizations](28-retained-row-optimizations/README.md) | Follow-on wins opened by compact retained rows | `H3` graduated with its trade (`D10`); next is `H7`'s reflow read and the resize profile |
