...
| 41 | [Baseline memory with ten tabs](41-baseline-memory-ten-tabs/README.md) | What the process holds with many idle tabs, by allocation class | Phase 3 banked: 644 MB to 56.5 MB idle (`F10`); the remainder is two classes (`F12`); `T4` open |
