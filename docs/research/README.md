...
| 28 | [Retained-row optimizations](28-retained-row-optimizations/README.md) | Follow-on wins opened by compact retained rows | C6 landed at 14.1x depth, then resize came back 14.2x slower; H3 blocked on `D7`'s trade |
