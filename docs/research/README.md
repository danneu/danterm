...
| 41 | [Baseline memory with ten tabs](41-baseline-memory-ten-tabs/README.md) | What the process holds with many idle tabs, by allocation class | Phase 3: `T8` shipped the ideal, 56.9 MB idle; `D5` cut the fast path; `T9`/`T2b` next |
