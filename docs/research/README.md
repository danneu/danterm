...
| 41 | [Baseline memory with ten tabs](41-baseline-memory-ten-tabs/README.md) | What the process holds with many idle tabs, by allocation class | Phase 1: `vmmap` on the empty arm to confirm `H1`; latency control |
