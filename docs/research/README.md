...
| 28 | [Retained-row optimizations](28-retained-row-optimizations/README.md) | Follow-on wins opened by compact retained rows | Memory won, resize fixed, browsing cut to +3.27% by `F17`; gate still fails on admission; H3 open |
