...
| 31 | [Logical-line scrollback](31-logical-line-scrollback/README.md) | Storing history as unwrapped logical lines, wrapped at read | Graduated to plans/impl/; `D4` freezes the eviction rule; the paired ladder is owed |
