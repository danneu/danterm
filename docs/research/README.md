...
| 28 | [Retained-row optimizations](28-retained-row-optimizations/README.md) | Follow-on wins opened by compact retained rows | C6's memory win holds and `D8` fixed resize; browsing reads still fail the gate; H3 open on `F17` |
