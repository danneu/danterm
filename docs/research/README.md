...
| 37 | [SIMD opportunities](37-simd-opportunities/README.md) | Where explicit SIMD or vectorization would pay, ranked by impact x confidence | Phase 1: sample `appendCells` and `eraseCells` into `F2`, then gate `D1` |
